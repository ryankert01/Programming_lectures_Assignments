...
HugeInteger< T > HugeInteger< T >::square( value_type powerTwo )
{
   ...
   typename vector< long long int >::iterator sqIt = square.begin();
   ...
   for(sqIt = square.begin(); sqIt != square.end(); sqIt++)
       if (*sqIt >= powerTwo)
       {
   ...
   HugeInteger square1( square.size() );
   typename T::iterator sqIt1 = square1.integer.begin();
   for (sqIt = square.begin(); sqIt != square.end(); sqIt++, sqIt1++)
       *sqIt1 = *sqIt;
