...
void HugeInteger< T >::operator-=(HugeInteger< T >& op2)
{
	...
	using iterVec = typename vector< T >::iterator;
	iterVec it2 = op2.integer.begin();
	iterVec it1 = difference.integer.begin();

	for (iterVec it1 = difference.integer.begin(); it1 != difference.integer.end(); ++it1, ++it2)
		*it1 -= *it2;
	
	for(iterVec it1 = difference.integer.begin(); it1 != difference.integer.end(); ++it1)
